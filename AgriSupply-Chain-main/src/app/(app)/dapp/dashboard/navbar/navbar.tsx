...
import { DropdownMenuProfile } from "./navdrop";
...
<nav className={` bg-white w-full flex relative justify-between items-center mx-auto px-8 h-20 ${sidebarOpen ? 'w-64' : 'w-5'}`}>
        ...
        <div className="block">
            <div className="inline relative">
                <button type="button" className="inline-flex items-center relative px-2 border rounded-full hover:shadow-lg">
                    ...
                    <div className="block flex-grow-0 flex-shrink-0 h-10 w-12 pl-5 mr-20">
                        <DropdownMenuProfile />
                    </div>
                </button>
            </div>
