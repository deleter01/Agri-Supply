  ...
  return (
    <nav className={`transition-all duration-300 overflow-x-hidden bg-gray-800 ${sidebarOpen ? 'w-64 p-10' : 'h-full w-5 p-9'}`}>
        ...
        <div className="flex flex-col space-y-4 mt-6 items-center justify-center relative text-white">
          ...
          <a href="products" className="group relative rounded-lg p-2 hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
            ...
            <div className="absolute inset-y-0 left-12 hidden items-center group-hover:flex">
              <div className="relative whitespace-nowrap rounded-md bg-white px-4 py-2 text-sm font-semibold text-gray-900 drop-shadow-lg">
                ...
                Add Product<span className="text-gray-400">(Y)</span>
              </div>
            </div>
          </a>

          <a href="users" className="group relative rounded-lg p-2 hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
